...
class Load{
    ...
    * inclui e instancia a biblioteca requisitada
    ...
    public function library($filename, $parameters = null, $autoExec = false)
    {
        ...
        $files = array(
            BASEPATH.DIRECTORY_SEPARATOR.APPPATH.DIRECTORY_SEPARATOR.LIBRARYPATH.DIRECTORY_SEPARATOR.$filename.'.php',
            BASEPATH.DIRECTORY_SEPARATOR.SYSTEMPATH.DIRECTORY_SEPARATOR.LIBRARYPATH.DIRECTORY_SEPARATOR.$filename.'.php',
